...
* **Briefing: Floating panel** — the Farmhand button above the bottom bar opens a panel organised by the question you came with: **Now** (what wants you this minute — turn-ins, one-item-away requests, stalled Craftworks slots), **Here** (the drop table of the place you're standing, with your count against the cap, who wants each drop, silver and XP per explore, stamina banked, and "wanted here" / "thrown away here" verdicts on top — or where to go, when you're nowhere in particular), **Goals**, **Craftworks** (queue advice and saved sets), and **Cap**.
